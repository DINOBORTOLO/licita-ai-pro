...
def index():
    ...
    return render_template('index.html')  # CORRIGIDO: era landing.html
...
def dashboard():
    ...
    return render_template('dashboard.html',  # CORRIGIDO: era index.html
                         user=current_user, 
...
def admin_dashboard():
    ...
    return render_template('admin_dashboard.html',  # CORRIGIDO: não usa pasta admin/
...
def admin_usuarios():
    ...
    return render_template('admin_usuarios.html',  # CORRIGIDO
                         usuarios=usuarios,
                         planos=PLANOS,
...
def admin_editar_usuario(id):
    ...
    return render_template('admin_editar_usuario.html', usuario=usuario, planos=PLANOS)  # CORRIGIDO
...
def admin_financeiro():
    ...
    return render_template('admin_financeiro.html',  # CORRIGIDO
